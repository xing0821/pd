...
func init() {
	RegisterScheduler("grant-leader", func(opController *schedule.OperatorController, args []string) (Scheduler, error) {
		if len(args) != 1 {
...
// to a store.
func newGrantLeaderScheduler(opController *schedule.OperatorController, storeID uint64) Scheduler {
