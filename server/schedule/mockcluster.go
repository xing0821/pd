...
func NewMockSchedulerOptions() *MockSchedulerOptions {
	...
	mso.SchedulerMaxWaitingOperator = defaultReplicaScheduleLimit
	return mso
}
...
// GetSchedulerMaxWaitingOperator mock method
func (mso *MockSchedulerOptions) GetSchedulerMaxWaitingOperator() uint64 {
