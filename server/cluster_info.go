...
func (c *clusterInfo) OfflineStoreScheduleCost() int64 {
	return c.opt.OfflineStoreScheduleCost()
}

func (c *clusterInfo) OfflineStoreBucketRate() float64 {
	return c.opt.OfflineStoreBucketRate()
}
